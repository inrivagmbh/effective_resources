module EffectiveResources
  class Engine < ::Rails::Engine
    ...
    config.autoload_paths += Dir["#{config.root}/lib/", "#{config.root}/app/", "#{config.root}/app/controllers/", "#{config.root}/app/controllers/concerns/", "#{config.root}/app/controllers/concerns/effective/"]
